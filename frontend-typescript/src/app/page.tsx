...
export default function Home() {
  ...
  const fetchUsers = async () => {
    try {
      const apiResponse = await axios.get<{ listUser: User[] }>(`${apiURL}/user/get-user`);
  ...
  const fetchConversations = async () => {
    try {
      const apiResponse = await axios.get<{ conversation: Conversation[] }>(`${apiURL}/conversation/get-conversation`);
